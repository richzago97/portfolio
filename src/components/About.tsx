                ...
                xl:max-w[520px] xl:border dark:border-none"
                     ...
                     <div className="text-lg mt-12 xl:mt-8">
                        <TabsContent value="personal">
                           <div className="text-center xl:text-left">
                              <h3 className="h3 mb-4">
                                 Qualidade de Serviço por mais de 2 Anos
                              </h3>
                              <p className="subtitle max-w-xl mx-auto xl:mx-0">
                                 Impulsionado por uma curiosidade insaciável,
                                 dedico-me à arte da programação, envolvendo-me
                                 em novos projetos e em aprendizado contínuo.
                              </p>
                              ...
                              <div className="flex flex-col gap-y-2">
                                 <div className="text-primary">Idioma</div>
                        ...
                        <TabsContent value="skills">
                           <div className="text-center xl:text-left">
                              <h3 className="h3 mb-8">O que eu uso</h3>
                              {/* Skills */}
                              <div className="mb-16">
