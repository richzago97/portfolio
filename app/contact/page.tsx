      ...
      <div className="container mx-auto">
        ...
        xl:mb-24">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="subtitle max-w-[400px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum, cum! Voluptates perferendis assumenda ipsum at, minus recusandae eos. </p>
          </div>
          {/* Illustration */}
